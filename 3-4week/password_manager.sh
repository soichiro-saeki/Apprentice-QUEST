while true; do
        ...
        case $answer in "Add Password") read -p "サービス名を入力してください: " service
        read -p "ユーザー名を入力してください: " user read -p "パスワードを入力してください: " pass
        passfile=$(gpg -d passmanege.txt.gpg)
        echo $passfile $ '\' $service:$user:$pass | gpg -e -r goku.sou19941126@gmail.com passmanege.txt ;; "Get Password")
